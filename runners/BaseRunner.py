...
class BaseRunner(ABC):
    ...
    def test_sample(self):
        self.test_image(self.net, self.config.args.test_image_path, self.config.args.output_path)

    def ui(self, test_image_path, output_path):
        self.test_image(self.net, test_image_path, output_path)